...
<picture>
  <source
    ...
    srcset="https://capsule-render.vercel.app/api?type=waving&color=0:0d0d0d,100:1a0533&height=160&section=header&text=Rijan%20Poudel&fontSize=46&fontColor=ede0ff&fontAlignY=52&animation=fadeIn&desc=Frontend%20Developer%20%E2%80%94%20UI%20Engineer&descSize=15&descAlignY=72&descColor=9d7bc4"
  />
  <img
    src="https://capsule-render.vercel.app/api?type=waving&color=0:f5f0ff,100:e8d9ff&height=160&section=header&text=Rijan%20Poudel&fontSize=46&fontColor=3b0764&fontAlignY=52&animation=fadeIn&desc=Frontend%20Developer%20%E2%80%94%20UI%20Engineer&descSize=15&descAlignY=72&descColor=7c3aed"
    alt="header"
  />
</picture>
...
I'm a frontend developer based in Nepal who cares about the craft — the spacing, the transitions, the interaction rhythm, and all the decisions most people never notice but always feel. I work primarily in **React**, **Next.js**, **TypeScript**, and **Tailwind CSS**, and I complement that with backend work in **Python** and **Django** when the project calls for it.

My work tends to sit somewhere between utility and personality. I'm drawn to interfaces that have a point of view — things that feel designed rather than assembled. Lately I've been thinking a lot about retro-inspired aesthetics, AI-assisted creative tools, and what it means to build a frontend with real architectural intent.

I have **25 public repositories** across frontend, fullstack, and applied ML. I hold the **Pull Shark**, **YOLO**, and **Quickdraw** GitHub achievements.

---

## What I'm working on

- Pushing toward intentional, well-documented design systems
- Experimenting with retro UI aesthetics and visual character
- Deepening fullstack architecture through Python & Django
- Exploring AI-assisted creative and development workflows
- Building things that have both function and personality
...
These are the repos I'd point someone to first — a mix of UI experiments, applied ML, and product-minded builds.
...
A complete list of public work — 25 repositories spanning UI, fullstack, and ML.
...
|---|---|---|
| Pull Shark | **Pull Shark** | Opened pull requests that have been successfully merged |
| YOLO | **YOLO** | Merged a pull request without a code review |
| Quickdraw | **Quickdraw** | Closed an issue or pull request within 5 minutes of opening |
...
<picture>
  <source
    media="(prefers-color-scheme: dark)"
    srcset="https://capsule-render.vercel.app/api?type=waving&color=0:1a0533,100:0d0d0d&height=110&section=footer&animation=fadeIn"
  />
  <img
    src="https://capsule-render.vercel.app/api?type=waving&color=0:e8d9ff,100:f5f0ff&height=110&section=footer&animation=fadeIn"
    alt="footer"
  />
</picture>
